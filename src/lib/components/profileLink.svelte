<script>
  export let username = 'some cool user';
  export let photoURL = 'default.png';
</script>

<!-- 
  When looking at all users, this link will be used 
  to give a link to a specific user profile
 -->
